 ...
 */
abstract class Ingredients implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Map\\IngredientsTableMap';
    ...
    /**
     * Initializes internal state of Base\Ingredients object.
     */
    ...
    /**
     * Compares this with another <code>Ingredients</code> instance.  If
     * <code>obj</code> is an instance of <code>Ingredients</code>, delegates to
     * <code>equals(Ingredients)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[IngredientsTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[IngredientsTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[IngredientsTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : IngredientsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : IngredientsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : IngredientsTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = IngredientsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Ingredients'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildIngredientsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Ingredients::setDeleted()
     * @see Ingredients::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildIngredientsQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                IngredientsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(IngredientsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(IngredientsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(IngredientsTableMap::COL_DESCRIPTION)) {
    ...
    {
        $pos = IngredientsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Ingredients'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Ingredients'][$this->hashCode()] = true;
        $keys = IngredientsTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(IngredientsTableMap::COL_ID)) {
            $criteria->add(IngredientsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(IngredientsTableMap::COL_NAME)) {
            $criteria->add(IngredientsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(IngredientsTableMap::COL_DESCRIPTION)) {
            $criteria->add(IngredientsTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildIngredientsQuery::create();
        $criteria->add(IngredientsTableMap::COL_ID, $this->id);
     ...
     * If this ChildIngredients is new, it will return
    ...
    public function setRecipes(Collection $recipes, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($recipesToDelete as $recipeRemoved) {
            $recipeRemoved->setIngredients(null);
        }
     ...
     * Otherwise if this Ingredients is new, it will return
     * an empty collection; or if this Ingredients has previously
     * been saved, it will retrieve related Recipes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Ingredients.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildRecipe}> List of ChildRecipe objects
     */
    public function getRecipesJoinCocktails(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildRecipeQuery::create(null, $criteria);
        $query->joinWith('Cocktails', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(IngredientsTableMap::DEFAULT_STRING_FORMAT);
    }
