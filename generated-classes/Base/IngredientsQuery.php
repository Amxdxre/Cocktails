 ...
 *
 * @method     ChildIngredientsQuery leftJoinRecipe($relationAlias = null) Adds a LEFT JOIN clause to the query using the Recipe relation
 * @method     ChildIngredientsQuery rightJoinRecipe($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Recipe relation
 * @method     ChildIngredientsQuery innerJoinRecipe($relationAlias = null) Adds a INNER JOIN clause to the query using the Recipe relation
 *
 * @method     ChildIngredientsQuery joinWithRecipe($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Recipe relation
 *
 * @method     ChildIngredientsQuery leftJoinWithRecipe() Adds a LEFT JOIN clause and with to the query using the Recipe relation
 * @method     ChildIngredientsQuery rightJoinWithRecipe() Adds a RIGHT JOIN clause and with to the query using the Recipe relation
 * @method     ChildIngredientsQuery innerJoinWithRecipe() Adds a INNER JOIN clause and with to the query using the Recipe relation
 *
...
abstract class IngredientsQuery extends ModelCriteria
{
    ...
    public function filterByRecipe($recipe, ?string $comparison = null)
    {
        if ($recipe instanceof \Recipe) {
            $this
                ->addUsingAlias(IngredientsTableMap::COL_ID, $recipe->getIngredientId(), $comparison);
